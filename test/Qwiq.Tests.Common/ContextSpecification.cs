...
namespace Microsoft.Qwiq.Tests.Common
{
    ...
    /// </summary>
    /// <remarks>
    /// Behavior-driven development (BDD) is based on test-driven development (TDD). TDD is a software development methodology which essentially states that for each unit of software, a software developer must:
    /// <ul>
    ...
    /// </ul>
    /// TDD tends to get far into the detail, which doesn't resonate with non-technical individuals. BDD specifies that tests of any unit of software should be specified in terms of the desired behavior of the unit.
    /// BDD takes advantage of user stories to represent the intended behavior of components in a vertical slice, experienced as a user or client would experience the behavior. This perspective keeps focus on and allows
    /// the engineer to prioritize what is and isn't imporant to test.
    ///
    ...
    ///
    /// Notice that the language contains nouns with capital letters (Cart, Item, etc.) to drive out a native domain language
    /// (see Evans & Fowler (2003). Domain-Driven Design: Tackling complexity in the Heart of Software. Prentice Hall.). The <see cref="ContextSpecification" />
    ...
    /// </code>
    ///
    /// The TRX file is XML, and can be transformed to HTML to generate a report of capabilities of the system automatically
