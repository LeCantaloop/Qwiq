namespace Microsoft.Qwiq.Mocks
{
    ...
    {
        internal MockFieldDefinition(int id, string name, string referenceName)
            : base(id, referenceName, name)
        {
        }

        internal MockFieldDefinition(string name, string referenceName)
            : base(referenceName, name)
        {
        }

        /// <summary>
        ///     Given a reference name or friendly name, attempt to look up from existing fields. If the field is not a core field,
