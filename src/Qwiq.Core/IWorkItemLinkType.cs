namespace Qwiq
{
    ...
    {
        /// <summary>
        ///     Link type of the link at the source work item. The <see cref="INamed.Name" /> appears when you add
        ...
        /// <summary>
        ///     Link type of the link at the target work item.  The <see cref="INamed.Name" /> appears when a listing
