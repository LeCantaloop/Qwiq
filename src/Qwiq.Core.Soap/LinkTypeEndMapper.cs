...
namespace Microsoft.Qwiq.Soap
{
    ...
    {
        public static TeamFoundation.WorkItemTracking.Client.WorkItemLinkTypeEnd Map(TeamFoundation.WorkItemTracking.Client.WorkItemStore store, IWorkItemLinkTypeEnd end)
        {
